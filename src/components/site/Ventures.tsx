...
const ventures = [
  {
    name: "SR18 Beverages Pvt. Ltd.",
    sector: "Beverages",
    year: "2023",
    desc: "An ambitious beverage company crafting modern Indian flavours for the next generation.",
  },
  {
    name: "Delhi 6",
  ...
  },
  {
    ...
    sector: "Consumer",
    year: "—",
    desc: "A modern lifestyle brand designed around quality and intent.",
  },
  {
...
export function Ventures() {
  return (
    <section id="ventures" className="relative py-28 md:py-40 bg-background">
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
          ...
          <p className="max-w-md text-ink-soft text-lg leading-[1.75] reveal">
            Eight companies. One operating philosophy. Each built to compound value independently —
            and together.
          </p>
        </div>

        <div className="stack-scene grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          {ventures.map((v, i) => (
            <StackedCard key={v.name} index={i} className="stack-sticky">
              <article className="venture-card group p-8 md:p-10 min-h-[360px] h-full flex flex-col justify-between">
                ...
                <div className="my-10 relative">
                  <div className="absolute -left-2 -top-2 h-12 w-12 rounded-full bg-accent/25 blur-xl" />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-border">
                    ...
                    <span className="h-8 w-8 rounded-full border border-ink/30 flex items-center justify-center text-xs group-hover:bg-ink group-hover:text-background transition-colors">
                      →
                    </span>
                  </div>
                </div>

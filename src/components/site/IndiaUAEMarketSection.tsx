...
const markets = [
  {
    ...
    description: "UAE opportunity, global access and the momentum to open future-facing markets.",
  },
  {
    country: "India",
    flag: "🇮🇳",
    ...
    description: "Indian scale, enterprise depth and the operating ambition to build enduring value.",
  },
];
...
export function IndiaUAEMarketSection() {
  ...
  return (
    <section
      id="markets"
      ref={sectionRef}
      className="india-uae-stack-section relative overflow-hidden bg-[#f6f2e9] py-20 md:py-28 lg:py-32"
    >
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-6 md:px-10">
        <div className="grid grid-cols-1 gap-10 md:gap-12 lg:min-h-[calc(100vh-8rem)] lg:grid-cols-[minmax(0,0.82fr)_minmax(0,1fr)] lg:items-center lg:gap-14 xl:gap-18">
          <div className="max-w-2xl lg:sticky lg:top-28 lg:self-center">
            <div className="flex items-center gap-4">
              <span className="h-px w-12 bg-accent" />
              <span className="eyebrow">UAE → India</span>
            </div>
            <h2 className="mt-6 max-w-[15ch] font-display text-display-md md:mt-8">
              <span className="block xl:whitespace-nowrap">Connecting UAE</span>
              <span className="block xl:whitespace-nowrap">opportunity with</span>
              <span className="block xl:whitespace-nowrap">Indian scale</span>
            </h2>
            <p className="mt-6 max-w-xl text-[1.02rem] leading-[1.75] text-ink-soft md:mt-8 md:text-lg">
              Building ventures from the UAE into India through operating discipline, trusted
              partnerships and a clear view of cross-market growth.
            </p>
            <div
              className="mt-9 flex items-center gap-3 text-3xl md:mt-11"
              aria-label="UAE to India"
            >
              <span>🇦🇪</span>
              ...
              {markets.map((market, index) => (
                ...
                >
                  <div className="reactive-card__surface">
                    <div className="relative min-h-[420px] sm:min-h-[460px] md:min-h-[540px] lg:min-h-[min(68vh,640px)]">
                      <img
                        src={market.image}
                      ...
                      <div className="relative flex min-h-[420px] flex-col justify-between p-6 sm:min-h-[460px] sm:p-8 md:min-h-[540px] md:p-11 lg:min-h-[min(68vh,640px)]">
                        <div className="flex items-start justify-between gap-6">
                          ...
                          <span className="text-4xl leading-none md:text-6xl" aria-hidden="true">
                            {market.flag}
                          </span>
                        </div>
                        ...
                        <div>
                          ...
                          <h3 className="font-display text-[clamp(3.4rem,18vw,5rem)] leading-none md:text-[6.5rem] lg:text-[clamp(5rem,7vw,6.5rem)]">
                            {market.country}
                          </h3>
                          <p className="mt-5 max-w-lg text-[0.98rem] leading-[1.7] text-background/76 md:text-lg">
                            {market.description}
                          </p>
                        </div>
                      </div>

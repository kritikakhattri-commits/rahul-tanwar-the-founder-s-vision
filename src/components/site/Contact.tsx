      ...
      <div className="mx-auto max-w-[1600px] px-6 md:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-end">
          ...
          <div className="lg:col-span-4">
            <div className="rounded-[1.5rem] bg-card p-8 md:p-10 shadow-[var(--shadow-soft)] space-y-8">
              <div>
              ...
              <div>
                ...
                <a
                  ...
                  className="mt-2 block overflow-wrap-anywhere font-display text-2xl"
                >
  ...
  return (
    <footer className="border-t border-accent/25 bg-secondary text-background py-12">
      <div className="mx-auto max-w-[1600px] px-6 md:px-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
        ...
        <div className="max-w-full text-xs font-medium tracking-[0.14em] uppercase text-background/65 md:text-center">

    ...
    >
      <div className="mx-auto max-w-[1600px] px-6 md:px-10 h-20 flex items-center justify-between">
        <a href="#top" className="flex items-center gap-3 group">
          ...
          <span className="font-display text-xl tracking-tight">Rahul Tanwar</span>
        </a>
        ...
        <nav className="hidden md:flex items-center gap-8">
          {links.map((l) => (
            <a
              key={l.href}
              href={l.href}
              className="relative text-[12px] tracking-[0.2em] uppercase text-ink-soft hover:text-foreground transition-colors group"
            >
              {l.label}
      ...
      {/* Mobile menu */}
      <div
        className={`md:hidden overflow-hidden transition-[max-height] duration-500 bg-background border-b border-border ${
